  ...
  try {
    ...
    if (user) {
      ...
      if (platform == PLATFORM.WEB){
        if (
          !LOGIN_ACCESS[user.userType].includes(USER_TYPES.SUPER_ADMIN) ||
          !LOGIN_ACCESS[user.userType].includes(USER_TYPES.EMPLOYEE) ||
          !LOGIN_ACCESS[user.userType].includes(USER_TYPES.TEAM_LEAD) ||
          !LOGIN_ACCESS[user.userType].includes(USER_TYPES.HR)
        ) {
          return {
            flag: true,
